...
export const CHIPS = {
  ...
  moodGood: ["work", "joke", "contact"],
  moodBad: ["work", "music", "joke"],
  noted: ["work", "about"],
  abilities: ["work", "zetsu", "contact"],
...
export const LINES = {
  ...
  abilities: [
    "Loads. I open every app on this desktop, talk through all seven AI systems, start the music, and take voice orders. Try “show me Zetsu”. Or just say hi — I'm good at hi.",
    "I'm the tour guide with keys to everything. Projects, résumé, terminal, contact, music — name it and I'll open it. And I gossip about Alistair on request.",
    "Talk, tap, or speak. I explain the work, open the apps, play the mix, and remember your voice preference. Go on, test me.",
  ],
  moodGood: [
    "Love to hear it. Good days deserve good demos — want the tour?",
    "Excellent. Bottling some of that energy for later. What shall we look at?",
    "That's the spirit. Everything's better with an audience — show you the work?",
  ],
  moodBad: [
    "Sorry to hear that. Rough days pass — want a distraction? The Mars station is weirdly calming.",
    "That sounds heavy. Can't fix it from here, but I can show you something he built. Small wins count.",
    "Ugh, those days. Deep breath. Want the quick tour, or just some music?",
  ],
  noted: [
    "Noted. Steady counts for a lot. What next?",
    "Fair enough. Even keel, full speed ahead — where to?",
  ],
  voiceOn: [
...
export const ROUTES = [
  ...
  [/not bad|pretty good|doing well|feeling good|i'?m (doing )?(good|great|fine|well)|i'?m (so |really )?(happy|amazing|awesome|fantastic)|^(great|good|fine|amazing|awesome)\s*[!.]?$/i, "moodGood"],
  [/\b(bad|sad|tired|exhausted|stressed|busy|bored|lonely|terrible|awful|horrible|meh)\b|i'?m not (good|great|fine|well)|feeling (down|blue|low)/i, "moodBad"],
  [/^(ok|okay|alright|fine then)\s*[!.]?$|i'?m ok\b|that'?s ok\b|it'?s ok\b/i, "noted"],
  ...
  [/help|what can you do|what do you do|abilities|capabilities/i, "abilities"],
